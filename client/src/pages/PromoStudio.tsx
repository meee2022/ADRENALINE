...
const BRANDS: Record<Brand, {
  ...
  ADRENALINE: {
    ...
    images: [
      ...
      { src: "/promo-coach-male-meal.png", ar: "مدرب مع وجبة أدرينالين", en: "Coach with Adrenaline meal" },
      { src: "/promo-coach-female-meal.png", ar: "مدربة مع وجبة أدرينالين", en: "Female coach with meal" },
      { src: "/promo-coach-community-meals.png", ar: "المدربون ووجبات المطعم", en: "Coaches & restaurant meals" },
