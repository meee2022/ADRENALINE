...
export const MENU_SECTIONS: MenuSection[] = [
  {
    ...
    titleEn: "General",
    items: [
      { href: "/", iconKey: "home", labelAr: "عرض الموقع", labelEn: "View website",
      ...
      { href: "/dashboard", iconKey: "dashboard", labelAr: "لوحة التحكم", labelEn: "Dashboard",
        roles: ["ADMIN"] },
      { href: "/admin-center", iconKey: "dashboard", labelAr: "مركز الإجراءات", labelEn: "Action Center",
        roles: ["ADMIN"] },
    ],
  },
  {
    ...
    items: [
      ...
      { href: "/orders/pending", iconKey: "ordersPending", labelAr: "مراجعة الطلبات", labelEn: "Review Orders",
        roles: ["ADMIN", "NUTRITIONIST"] },
      { href: "/crm", iconKey: "customers", labelAr: "متابعة العملاء", labelEn: "Customer Follow-up",
        roles: ["ADMIN", "NUTRITIONIST"] },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/promo-studio", iconKey: "promoStudio", labelAr: "استوديو الحملات", labelEn: "Promo Studio",
        roles: ["ADMIN"] },
      { href: "/send-payment-link", iconKey: "sendPaymentLink", labelAr: "إرسال رابط دفع", labelEn: "Send Payment Link",
        roles: ["ADMIN"] },
