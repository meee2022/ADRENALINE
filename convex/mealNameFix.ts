...
const FIXES: Fix[] = [
  ...
  /* ⛔ تراجع: غيّرناه لـ«برياني الروبيان» بناءً على الصورة (المصدر يعرض روبيان).
   *    لكن جدول الإكسل — خطة المطبخ الرسمية — يقرّر «CHICKEN BIRYANI» لأسبوع 3
   *    الأحد، وهي نفس الخانة المجدولة لهذه الوجبة. الإكسل هو المرجع لما يطبخه
   *    المطبخ، لا الصورة. ⇒ الطبق دجاج، والصورة هي الخطأ (تحتاج تصويراً). */
  { ar: "برياني الروبيان", newAr: "برياني الدجاج", newEn: "Chicken Biryani",
    why: "تراجع — الإكسل يقرّر Chicken Biryani لأسبوع 3 الأحد." },
